    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('patient', 'Patient'), ('clinician', 'Clinician'), ('care_navigator', 'Care Navigator'), ('superuser', 'Site Super User')], default='patient', max_length=20)),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('phone_number', models.CharField(blank=True, max_length=20)),
                ('date_of_birth', models.DateField(blank=True, null=True)),
                ('nhs_number', models.CharField(blank=True, max_length=10, null=True, unique=True)),
